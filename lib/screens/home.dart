...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<void> _loadGear() async {
    ...
    // First launch (or corrupt data) — load seed examples and persist
    setState(() {
          ...
          children: [
            ...
            Expanded(
              child: _visible.isEmpty
                  ? const Center(child: Text('No matching gear'))
                  : ListView.separated(
                ...
                itemBuilder: (_, i) {
                  final g = _visible[i];
                  return ListTile(
                    title: Text('${g.brand} ${g.model}'),
                    subtitle: Text('${_cap(g.type)} — ${_cap(g.status)}'),
                    onTap: () => _openDetail(g),
